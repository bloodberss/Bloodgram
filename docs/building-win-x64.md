...
Open **x64 Native Tools Command Prompt for VS 2022.bat**, go to ***BuildPath*** and run
    ...
    git clone --recursive https://github.com/Bloodgram/BloodgramDesktop.git tdesktop
...
* The result Bloodgram.exe will be located in **D:\TBuild\tdesktop\out\Debug** (and **Release**)
