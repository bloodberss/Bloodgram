...
#ifdef OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"Bloodgram.BloodgramDesktop.Store";
#else // OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"Bloodgram.BloodgramDesktop";
#endif // OS_WIN_STORE
...
void CleanupShortcut() {
	...
	QString path = systemShortcutPath() + u"Bloodgram.lnk"_q;
...
bool checkInstalled(QString path = {}) {
	...
	const auto installed = u"Bloodgram Desktop/Bloodgram.lnk"_q;
	const auto old = u"Bloodgram for Windows/Bloodgram.lnk"_q;
